...
@section('title', 'Nova telemetria - Veículos - Omega286')
@section('eyebrow', 'Operação / Veículos')
@section('page-title', 'Novo registro de telemetria')

@section('content')
    <form method="POST" action="{{ route('veiculos.telemetria.store') }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
