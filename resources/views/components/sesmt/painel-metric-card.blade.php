...
<div {{ $attributes->merge(['class' => 'flex min-w-0 flex-col items-center justify-center gap-3 rounded-xl border border-[#E0E0E0] bg-white px-4 py-8 text-center shadow-sm sm:gap-3.5 sm:py-9']) }}>
