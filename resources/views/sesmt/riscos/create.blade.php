...
@section('title', 'Novo risco — SSMA - Omega286')
@section('eyebrow', 'SSMA / Gestão de Riscos')
@section('page-title', 'Novo risco')
...
@section('content')
    <section class="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm md:p-8">
        <form method="POST" action="{{ route('sesmt.riscos.store') }}" enctype="multipart/form-data" class="max-w-4xl">
            @csrf
