    ...
    <div class="min-w-0 flex-1">
        <div class="flex gap-5">
            ...
            <div class="min-w-0 pt-0.5">
                <h2 class="text-2xl font-bold tracking-tight text-[#600020] sm:text-[1.65rem]">Boas Práticas, Kaizen e Melhorias Implementadas</h2>
                <p class="mt-2 text-sm leading-relaxed text-zinc-500">Evolução das melhorias aplicadas, ganhos obtidos e valorização das boas práticas no período.</p>
