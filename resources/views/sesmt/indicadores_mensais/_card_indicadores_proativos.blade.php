    ...
    <div class="min-w-0 flex-1">
        <div class="flex gap-5">
            ...
            <div class="min-w-0 pt-0.5">
                <h2 class="text-2xl font-bold tracking-tight text-[#600020] sm:text-[1.65rem]">Indicadores Proativos de Segurança</h2>
                <p class="mt-2 text-sm leading-relaxed text-zinc-500">Ações preventivas e controle antecipado de riscos no período.</p>
