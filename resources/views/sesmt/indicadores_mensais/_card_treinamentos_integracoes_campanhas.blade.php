    ...
    <div class="min-w-0 flex-1">
        <div class="flex gap-5">
            ...
            <div class="min-w-0 pt-0.5">
                <h2 class="text-2xl font-bold tracking-tight text-[#600020] sm:text-[1.65rem]">Treinamentos, Integrações e Campanhas</h2>
                <p class="mt-2 text-sm leading-relaxed text-zinc-500">Capacitação, conscientização e aderência aos requisitos obrigatórios no período.</p>
