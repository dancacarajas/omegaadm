    ...
    <div class="min-w-0 flex-1 basis-0">
        <div class="flex min-w-0 w-full gap-5">
            ...
            <div class="min-w-0 max-w-2xl flex-1 pt-0.5">
                <h2 class="text-balance text-2xl font-bold tracking-tight text-zinc-900 sm:text-[1.65rem]">Desvios, Notificações e Tratativas</h2>
                <p class="mt-2 max-w-prose text-sm leading-relaxed text-zinc-500">Controle dos desvios identificados, notificações emitidas e status das tratativas no período.</p>
